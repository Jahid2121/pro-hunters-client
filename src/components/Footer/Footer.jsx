...
const Footer = () => {
  return (
    <footer className="bg-white mb-0 sticky  ml-14 dark:bg-gray-900">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-sm">
              ProHunters is the largest talent platform <br /> in Southeast Asia
              for <br />
              career development and <br /> recruitment.
            </p>
          </div>
